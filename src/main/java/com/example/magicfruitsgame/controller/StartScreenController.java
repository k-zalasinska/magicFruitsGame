...
//        Image backgroundImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/background.jpg")));
//        backgroundImageView.setImage(backgroundImage);
//
//        // Ustawienie obrazków przycisków
//        Image buttonStartNormalImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_start_normal.png")));
//        buttonStart.setGraphic(new ImageView(buttonStartNormalImage));
//
//        Image buttonPayInNormalImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_payin_normal.png")));
...
//            Image buttonStartOnHoverImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_start_onhover.png")));
...
//            Image buttonStartOnPressImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_start_onpress.png")));
//            buttonStart.setGraphic(new ImageView(buttonStartOnPressImage));
//        });
//
//        buttonPayIn.setOnMouseEntered(event -> {
//            Image buttonPayInOnHoverImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_payin_onhover.png")));
...
//            Image buttonPayInOnPressImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/button_payin_onpress.png")));
